...
class _SupportPageState extends State<SupportPage> {
  ...
  void initState() {
    ...
    phoneNumber = (webSettings != null && webSettings.supportNumber.isNotEmpty && webSettings.supportNumber != 'null') 
    ...
    return CustomScaffold(
      ...
      body: BlocBuilder<SettingsBloc, SettingsState>(
        builder: (context, state) {
          final webSettings = SettingsData.instance.web;
          final currentPhoneNumber = (webSettings != null && webSettings.supportNumber.trim().isNotEmpty && webSettings.supportNumber != 'null') 
              ? webSettings.supportNumber 
              : '8888081811';
          final currentEmail = (webSettings != null && webSettings.supportEmail.trim().isNotEmpty && webSettings.supportEmail != 'null') 
              ? webSettings.supportEmail 
              : 'groferyhoreca.@gmail.com';
            ...
            child: Column(
              ...
              children: [
                ...
                _buildContactCard(
                  ...
                  subtitle: currentPhoneNumber,
                  onTap: () => _launchUrl('tel:$currentPhoneNumber'),
                  onLongPress: () => _copyToClipboard(context, currentPhoneNumber, AppLocalizations.of(context)!.phoneNumberCopied),
                ),
