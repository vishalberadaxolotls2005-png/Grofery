...
class PaymentConfig {
  ...
  static final List<PaymentMethod> _paymentMethods = [
    ...
    PaymentMethod(
      ...
      id: 'phonepe',
      name: 'PhonePe',
      logoPath: '${_logoBasePath}phonepe.png',
      isOnline: true,
      isAvailable: true,
    ),
    PaymentMethod(
    ...
    PaymentMethod(
      ...
      id: 'flutterwave',
      name: 'Flutterwave',
      logoPath: '${_logoBasePath}flutterwave.png',
      isOnline: true,
      isAvailable: true,
    ),
    ...
    PaymentMethod(
      ...
      id: 'wallet',
      name: 'Wallet',
      logoPath: '${_logoBasePath}wallet.png',
    ...
    PaymentMethod(
      type: PaymentMethodType.directBankTransfer,
  ...
  static bool isPaymentMethodEnabledInSettings(String id) {
    ...
    switch (id) {
      ...
      case 'phonepe':
        return paymentSettings.phonepePayment;
      case 'paypal':
        return paymentSettings.paypalPayment; // Using the model field
      case 'flutterwave':
        return paymentSettings.flutterWavePayment;
      case 'wallet':
        final systemSettings = SettingsData.instance.system;
        final walletEnabledInSystem = systemSettings?.enableWallet ?? true;
        return walletEnabledInSystem && paymentSettings.wallet;
      case 'direct_bank_transfer':
        return paymentSettings.directBankTransfer;
      default:
        return false;
    }
  }
